        ...
        <div className="w-full flex flex-col">
            <Link href={ `/products/${ product.id }` } className="relative w-full h-72 mb-4">
                <div className="relative overflow-hidden w-full h-72 mb-4 rounded-sm">
                    ...
                    <Image unoptimized src={ product.images?.[0] ?? './assets/fallback-image.png' } placeholder='blur' blurDataURL={ product.images?.[0] } fill alt="product" className="absolute z-10 hover:opacity-0 transition-all duration-[600ms] object-cover" />
            ...
            <div className="p-0.5 flex flex-col gap-2">
                ...
                <div className='flex items-center justify-between pt-2'>
                    <Button className="w-24 px-12 rounded-full border-[1px] font-semibold border-primary text-primary cursor-pointer hover:bg-primary hover:text-white transition-all duration-300 ">More Info
                    </Button>
